...
Charts stay owned by ``chart_fill`` (which gives every output slide private
chart/workbook copies before applying any selective data edits) and notes slides
by ``notes``; both relationship types are skipped here.
"""
